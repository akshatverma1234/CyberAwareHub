...
const MagicBento = ({
  ...
  const baseClassName = `magic-bento-card relative overflow-hidden bg-[#060010] border border-[#392e4e] text-white p-6 rounded-2xl transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl ${
  ...
  return (
    <>
      ...
      <div ref={cardRef} className={baseClassName} style={cardStyle}>
        {children}
      </div>
    </>
  );
...
// Create a container component for spotlight effect
