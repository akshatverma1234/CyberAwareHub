...
const CommunityCaseStudiesClient = ({ initialStories, initialError }) => {
  ...
  const handleDeleteStory = async () => {
    ...
    try {
      ...
      context.openAlertBox(
        "error",
        `Error deleting case study: ${error.message}`
      );
    } finally {
      setSelectedId(null);
      setIsLoading(false);
...
export default CommunityCaseStudiesClient;
