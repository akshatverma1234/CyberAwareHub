const StorySubmissionEmail = (username, storyTitle) => {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>Hi ${username},</p>
      <p>We’ve successfully received your story titled <span class="highlight">"${storyTitle}"</span>.</p>
...
module.exports = StorySubmissionEmail;
