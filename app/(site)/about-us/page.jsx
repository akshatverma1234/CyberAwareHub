    ...
    <div className="bg-[#06080e] w-full min-h-screen">
      <div className="m-auto flex flex-col items-center justify-center p-28">
        ...
        <div className="flex flex-col items-center justify-center">
          <h1 className="text-white text-[48px] font-bold text-center mb-6">
            Cyber Awareness Hub
          </h1>
          <p className="text-white text-[18px] text-center max-w-4xl leading-relaxed">
      ...
      {/* Founder Section */}
      <div className="flex items-center justify-between max-w-7xl mx-auto px-8 mb-20">
        ...
        <div className="flex flex-col items-center">
          <img
            ...
            className="w-[450px] h-[550px] rounded-[15px] border-2 border-white mb-2 object-cover overflow-hidden"
          />
          <span className="text-white font-bold">Akshat Verma</span>
        </div>
      </div>

      <div className="flex items-center justify-center py-20 bg-[#0a0f1a]">
        <div className="flex flex-col items-center justify-center max-w-7xl mx-auto px-8">
          <h1 className="text-white text-[48px] font-bold mb-4 text-center">
            Our Mission
          </h1>
          <p className="text-blue-200 text-[20px] mb-12 text-center italic">
            Why We Exist
          </p>
          <div className="max-w-6xl text-justify flex flex-col gap-8">
            <p className="text-white text-[16px] leading-relaxed">
      ...
      <div className="py-20 bg-[#06080e]">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-white text-[42px] font-bold mb-4">
              What You'll Find Here
            </h2>
            <p className="text-blue-200 text-[18px] italic">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-[#0a0f1a] rounded-lg p-8 border border-blue-900 hover:border-blue-400 transition-all duration-300 hover:transform hover:scale-105"
              >
                <div className="flex items-center mb-4">
                  {service.icon}
                  <h3 className="text-white text-xl font-bold ml-3">
                    {service.title}
                  </h3>
                </div>
      ...
      <div className="py-20 bg-[#06080e]">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-blue-900/40 to-purple-900/40 rounded-lg p-8 border border-blue-800">
      ...
      <div className="py-20 bg-gradient-to-br from-[#0a0f1a] to-[#06080e]">
        <div className="max-w-7xl mx-auto px-8 text-center">
          <h2 className="text-white text-[42px] font-bold mb-6">
            Together, Let's Build a Safer Digital World
          </h2>
          <p className="text-blue-200 text-xl italic mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <Link href="/case-studies">
              <Button className="!bg-blue-600 hover:!bg-blue-700 !text-white !px-8 !py-4 !rounded-lg !font-semibold !transition-all !duration-300 hover:!transform hover:!scale-105 !flex !items-center">
                <Eye className="w-5 h-5 mr-2" />
                Explore Case Studies
              </Button>
            </Link>
            <Link href="/articles">
              <Button className="!bg-transparent !border-2 !border-blue-400 !text-blue-400 hover:!bg-blue-400 hover:!text-white !px-8 !py-4 !rounded-lg !font-semibold !transition-all !duration-300 hover:!transform hover:!scale-105 !flex !items-center">
                <BookOpen className="w-5 h-5 mr-2" />
                Read Articles
              </Button>
            </Link>
            <Link href="/community-stories">
              <Button className="!bg-purple-600 !hover:bg-purple-700 !text-white !px-8 !py-4 !rounded-lg !font-semibold !transition-all !transform hover:scale-105 flex !items-center">
